...
<html>
<head>
	<title>Budget Buddy Check Book</title>
	...
	?>
	<script type="text/javascript" src="Javascript/CheckBook.js">
	</script>
</head>
<body>
...
if(!$checkControl->valid($_SESSION['userID'])){
